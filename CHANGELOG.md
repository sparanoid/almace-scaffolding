...
* use more common fonts path ([c989bc49](https://github.com/sparanoid/almace-scaffolding/commit/c989bc49))
* watch files in subdirectories for grunt tasks ([2234f54b](https://github.com/sparanoid/almace-scaffolding/commit/2234f54b))
* sync init config file ([b22cfaf3](https://github.com/sparanoid/almace-scaffolding/commit/b22cfaf3))
* remove unnecessary task ([0fd0dc23](https://github.com/sparanoid/almace-scaffolding/commit/0fd0dc23))
* collar container width ([89e4eac6](https://github.com/sparanoid/almace-scaffolding/commit/89e4eac6))
* include the missing gem lock file ([2a546df9](https://github.com/sparanoid/almace-scaffolding/commit/2a546df9))
* **config:**
  * wront default value ([6bac731a](https://github.com/sparanoid/almace-scaffolding/commit/6bac731a))
  * typos ([7f5f46ce](https://github.com/sparanoid/almace-scaffolding/commit/7f5f46ce))
  * add missing `force_utf_8` option ([2ef2dc44](https://github.com/sparanoid/almace-scaffolding/commit/2ef2dc44))
* **grunt:**
  * avoid duplicated jekyll watch ([00b11a7c](https://github.com/sparanoid/almace-scaffolding/commit/00b11a7c))
  * missing base URL, new `grunt-html-smoosher` config ([bb02d899](https://github.com/sparanoid/almace-scaffolding/commit/bb02d899))
  * fix previous commit ([430f0a58](https://github.com/sparanoid/almace-scaffolding/commit/430f0a58))
  * css not minified if `config.cfg.base` defined ([6515c46d](https://github.com/sparanoid/almace-scaffolding/commit/6515c46d))
  * wrong scripts and styles URL when `site.base` is defined ([bb1e5fde](https://github.com/sparanoid/almace-scaffolding/commit/bb1e5fde))
  * `copy:serve` not copying scripts in subdirectories ([ccba58e9](https://github.com/sparanoid/almace-scaffolding/commit/ccba58e9))
  * not detecting newly added files ([f386d870](https://github.com/sparanoid/almace-scaffolding/commit/f386d870))
  * cached Jekyll metadata not purged ([44965f9a](https://github.com/sparanoid/almace-scaffolding/commit/44965f9a))
  * now also watches Jekyll configuration files ([cf63e34e](https://github.com/sparanoid/almace-scaffolding/commit/cf63e34e))
  * remove deprecated Grunt task `archive` ([bb62c8eb](https://github.com/sparanoid/almace-scaffolding/commit/bb62c8eb))
  * wrong script compile path ([f1bb55aa](https://github.com/sparanoid/almace-scaffolding/commit/f1bb55aa))
* **jekyll:** missing gist example due to recently Jekyll beta changes ([2989e23a](https://github.com/sparanoid/almace-scaffolding/commit/2989e23a))
* **package:** missing `grunt-html-smoosher` ([c54b001a](https://github.com/sparanoid/almace-scaffolding/commit/c54b001a))
* **post:**
  * dead external link ([a80744bc](https://github.com/sparanoid/almace-scaffolding/commit/a80744bc))
  * typo in “Chinese Copywriting Guidelines” ([4f24b6ba](https://github.com/sparanoid/almace-scaffolding/commit/4f24b6ba))
  * remove intense support for "Moonstruck Princess Extended" ([b263b5c9](https://github.com/sparanoid/almace-scaffolding/commit/b263b5c9))
  * update times symbol for post "Antiskill, Judgment Icon Set and Screensaver" ([8f053ae5](https://github.com/sparanoid/almace-scaffolding/commit/8f053ae5))
  * fix error page links for post “IterCast” ([da1a5fd5](https://github.com/sparanoid/almace-scaffolding/commit/da1a5fd5))
  * remove a bunch of gibberish generated by Sketch ([6f8eca38](https://github.com/sparanoid/almace-scaffolding/commit/6f8eca38))
  * update IterCast SVG title ([3276d9f6](https://github.com/sparanoid/almace-scaffolding/commit/3276d9f6))
  * fix post grammar ([d1cdebdd](https://github.com/sparanoid/almace-scaffolding/commit/d1cdebdd))
  * remove unwanted HTML comments for posts ([f5ffc0ee](https://github.com/sparanoid/almace-scaffolding/commit/f5ffc0ee))
* **sitemap:** duplicated URL definitions ([5ee82675](https://github.com/sparanoid/almace-scaffolding/commit/5ee82675))
* **style:**
  * better code appearance ([c6e0f5c2](https://github.com/sparanoid/almace-scaffolding/commit/c6e0f5c2))
  * remove unwanted margin for last-child ([68d288c0](https://github.com/sparanoid/almace-scaffolding/commit/68d288c0))
  * wrong .external media query directive ([cf9d5fa1](https://github.com/sparanoid/almace-scaffolding/commit/cf9d5fa1))
  * wrong GitHub Gist font size ([0544eafc](https://github.com/sparanoid/almace-scaffolding/commit/0544eafc))
  * update cite position for sparanoid.com ([26ef8c08](https://github.com/sparanoid/almace-scaffolding/commit/26ef8c08))
  * `pre` and `code` not aligned properly ([dffc75b0](https://github.com/sparanoid/almace-scaffolding/commit/dffc75b0))
  * table align overrides by default user agent styles ([45ded474](https://github.com/sparanoid/almace-scaffolding/commit/45ded474))
  * `.largetype` not centered ([c4be3b14](https://github.com/sparanoid/almace-scaffolding/commit/c4be3b14))
  * images in posts are not center aligned ([a3cf785b](https://github.com/sparanoid/almace-scaffolding/commit/a3cf785b))
  * re-apply navigation margin fix for align left layout ([77b5fc19](https://github.com/sparanoid/almace-scaffolding/commit/77b5fc19))
  * reset header text align for justified text ([70d49911](https://github.com/sparanoid/almace-scaffolding/commit/70d49911))
  * correct sub list margin ([e01d8830](https://github.com/sparanoid/almace-scaffolding/commit/e01d8830))
  * remove heading hyphens support ([e46edbc3](https://github.com/sparanoid/almace-scaffolding/commit/e46edbc3))
  * use `rem` for alternative title font size ([5e77e4e5](https://github.com/sparanoid/almace-scaffolding/commit/5e77e4e5))
  * remove deprecated styles, fix cite footer font color ([61bc2cce](https://github.com/sparanoid/almace-scaffolding/commit/61bc2cce))
  * fix wrong scoped style use ([79e71de0](https://github.com/sparanoid/almace-scaffolding/commit/79e71de0))
  * avoid line-height override for `jksf` ([d24663fd](https://github.com/sparanoid/almace-scaffolding/commit/d24663fd))
  * avoid smoosh container edge ([75f66dfc](https://github.com/sparanoid/almace-scaffolding/commit/75f66dfc))
  * remove padding reset for last child elements ([62caf45f](https://github.com/sparanoid/almace-scaffolding/commit/62caf45f))
  * more aggressive “last-child” reset ([7b55093d](https://github.com/sparanoid/almace-scaffolding/commit/7b55093d))
  * fix code block overflow scroll issue ([33be40d1](https://github.com/sparanoid/almace-scaffolding/commit/33be40d1))
  * fix mismatched color variables ([865c13d6](https://github.com/sparanoid/almace-scaffolding/commit/865c13d6))
  * clear float for `blockquote` footer ([1da7cf28](https://github.com/sparanoid/almace-scaffolding/commit/1da7cf28))
* **template:**
  * better Twitter Cards author support ([56f089c3](https://github.com/sparanoid/almace-scaffolding/commit/56f089c3))
  * excerpts should be markdownified for predefined `excerpt` YAML front matter ([654ed8d5](https://github.com/sparanoid/almace-scaffolding/commit/654ed8d5))
  * add missing `site.colorful_list ` scope ([8575c197](https://github.com/sparanoid/almace-scaffolding/commit/8575c197))
  * remove deprecated minimal-ui ([db466892](https://github.com/sparanoid/almace-scaffolding/commit/db466892))
  * correct style and script paths for subdirectory setup ([20f9a50f](https://github.com/sparanoid/almace-scaffolding/commit/20f9a50f))
  * avoid “layout not found” error introduced since Jekyll 2.2.0 ([b4f86289](https://github.com/sparanoid/almace-scaffolding/commit/b4f86289))
  * use Katakana middle dots ([cc0f0720](https://github.com/sparanoid/almace-scaffolding/commit/cc0f0720))
  * use original post subheading ([e528b137](https://github.com/sparanoid/almace-scaffolding/commit/e528b137))
  * apply markdownify for post description ([91e00249](https://github.com/sparanoid/almace-scaffolding/commit/91e00249))
  * correct error page title ([3821c6b2](https://github.com/sparanoid/almace-scaffolding/commit/3821c6b2))
  * temporary fix HTML entities for post title ([7be60fc2](https://github.com/sparanoid/almace-scaffolding/commit/7be60fc2))
  * update footer credit ([2f3aec23](https://github.com/sparanoid/almace-scaffolding/commit/2f3aec23))
  * fix SVG title for Safari Reader mode ([8b7cc843](https://github.com/sparanoid/almace-scaffolding/commit/8b7cc843))
  * wrong home link hover effect for specified post color scheme ([9bbca0f7](https://github.com/sparanoid/almace-scaffolding/commit/9bbca0f7))
* **test:** lesslint error ([fb341f60](https://github.com/sparanoid/almace-scaffolding/commit/fb341f60))
* **theme:** wrong theme slug for Curtana ([595432c3](https://github.com/sparanoid/almace-scaffolding/commit/595432c3))
* **travis:** build error ([b1a9a0af](https://github.com/sparanoid/almace-scaffolding/commit/b1a9a0af))


#### Features

* reset `site.base` for local development ([cd46627b](https://github.com/sparanoid/almace-scaffolding/commit/cd46627b))
* bump Jekyll version to 2.5.2, better performance ([a0294f88](https://github.com/sparanoid/almace-scaffolding/commit/a0294f88))
* update `apple-touch-icon.png` for @3x size ([38bf31ac](https://github.com/sparanoid/almace-scaffolding/commit/38bf31ac))
* update `abbr` appearance, remove title hack ([a76fe931](https://github.com/sparanoid/almace-scaffolding/commit/a76fe931))
* add `force_utf_8` option ([0fb4c702](https://github.com/sparanoid/almace-scaffolding/commit/0fb4c702))
* update logo ([8666ee91](https://github.com/sparanoid/almace-scaffolding/commit/8666ee91))
* update ChinaTel username and password ([f2412163](https://github.com/sparanoid/almace-scaffolding/commit/f2412163))
* better intense.js cursor handling ([9f5b45ac](https://github.com/sparanoid/almace-scaffolding/commit/9f5b45ac))
* remove `grunt-usemin` support ([326910e8](https://github.com/sparanoid/almace-scaffolding/commit/326910e8))
* add intense.js support ([58e2c4d8](https://github.com/sparanoid/almace-scaffolding/commit/58e2c4d8))
* split configuration files into 3 files for better user experience ([d5db218f](https://github.com/sparanoid/almace-scaffolding/commit/d5db218f))
* update apple-touch-icon ([050508b5](https://github.com/sparanoid/almace-scaffolding/commit/050508b5))
* better external link post indicator ([6393ea07](https://github.com/sparanoid/almace-scaffolding/commit/6393ea07))
* better Redcarpet configurations, add some useful Redcarpet extensions ([2bd1c2a1](https://github.com/sparanoid/almace-scaffolding/commit/2bd1c2a1))
* use `rsrc.sparanoid.com` for assets URL ([445257d3](https://github.com/sparanoid/almace-scaffolding/commit/445257d3))
* add a fancy banner at the bottom of every page ([0760b036](https://github.com/sparanoid/almace-scaffolding/commit/0760b036))
* **Gruntfile:**
  * add a fancy `time-grunt` plugin ([ab1c2822](https://github.com/sparanoid/almace-scaffolding/commit/ab1c2822))
  * new HTML smoosher task ([9d4dcb25](https://github.com/sparanoid/almace-scaffolding/commit/9d4dcb25))
* **basic:** theme support ([5939d5a6](https://github.com/sparanoid/almace-scaffolding/commit/5939d5a6))
* **build:**
  * try `grunt-release` task ([7ddb2f2d](https://github.com/sparanoid/almace-scaffolding/commit/7ddb2f2d))
  * update Travis ([95910f0e](https://github.com/sparanoid/almace-scaffolding/commit/95910f0e))
* **config:** update assets URL, CloudFront should be better ([acb54e77](https://github.com/sparanoid/almace-scaffolding/commit/acb54e77))
* **docs:** add new docs for themes ([04f0393f](https://github.com/sparanoid/almace-scaffolding/commit/04f0393f))
* **donate:** update copywriting ([a5f9387b](https://github.com/sparanoid/almace-scaffolding/commit/a5f9387b))
* **feed:** use `<small>` for external link ([69c0abc9](https://github.com/sparanoid/almace-scaffolding/commit/69c0abc9))
* **grunt:**
  * remove `grunt-html-validation` support ([ebd502d5](https://github.com/sparanoid/almace-scaffolding/commit/ebd502d5))
  * better theme switch handling ([2a58c96d](https://github.com/sparanoid/almace-scaffolding/commit/2a58c96d))
  * basic theme switching support ([08926758](https://github.com/sparanoid/almace-scaffolding/commit/08926758))
  * use `grunt-bump` instead of `grunt-release` ([87597f8e](https://github.com/sparanoid/almace-scaffolding/commit/87597f8e))
  * simplify grunt buid task ([85a9d0ac](https://github.com/sparanoid/almace-scaffolding/commit/85a9d0ac))
  * remove banner timestamp ([bc20e74e](https://github.com/sparanoid/almace-scaffolding/commit/bc20e74e))
  * tasks minor tweak ([e070f369](https://github.com/sparanoid/almace-scaffolding/commit/e070f369))
  * simplify banner ([7b5b9b38](https://github.com/sparanoid/almace-scaffolding/commit/7b5b9b38))
  * speed up serve task by passing JS files directly from `copy` ([0165c8db](https://github.com/sparanoid/almace-scaffolding/commit/0165c8db))
  * add multiple LESS output support ([568041ec](https://github.com/sparanoid/almace-scaffolding/commit/568041ec))
  * new grunt option `--fast`, build site without minification ([073fed50](https://github.com/sparanoid/almace-scaffolding/commit/073fed50))
  * add `grunt-lesslint` support ([0b928803](https://github.com/sparanoid/almace-scaffolding/commit/0b928803))
  * rename all `server` task names to `serve` ([2697fa90](https://github.com/sparanoid/almace-scaffolding/commit/2697fa90))
  * add live reload support (BrowserSync) ([9f78f654](https://github.com/sparanoid/almace-scaffolding/commit/9f78f654))
  * update `html-minifier`, make all whitespace collapsed to one character. ([93bfb422](https://github.com/sparanoid/almace-scaffolding/commit/93bfb422))
  * better grunt tasks excluding files those need post-process ([bce8cf73](https://github.com/sparanoid/almace-scaffolding/commit/bce8cf73))
* **jekyll:**
  * remove Gists support by default ([f88b0137](https://github.com/sparanoid/almace-scaffolding/commit/f88b0137))
  * tweak kramdown config ([4d3f033d](https://github.com/sparanoid/almace-scaffolding/commit/4d3f033d))
  * update jekyll, use default markdown and highlighter parser ([43209734](https://github.com/sparanoid/almace-scaffolding/commit/43209734))
  * use latest 3.0.0.beta2 ([603069ea](https://github.com/sparanoid/almace-scaffolding/commit/603069ea))
* **package:** introduce grunt-conventional-changelog ([c732236b](https://github.com/sparanoid/almace-scaffolding/commit/c732236b))
* **post:**
  * port AMSF docs ([48f6d506](https://github.com/sparanoid/almace-scaffolding/commit/48f6d506))
  * proofreading for post “Amazon S3 × CloudFront” ([5afd26dd](https://github.com/sparanoid/almace-scaffolding/commit/5afd26dd))
  * new post “Markdown Features Test” ([4a393f70](https://github.com/sparanoid/almace-scaffolding/commit/4a393f70))
  * new post “Markdown Features Test” ([6759ddd3](https://github.com/sparanoid/almace-scaffolding/commit/6759ddd3))
  * new article “Amazon S3 × CloudFront” ([347624c9](https://github.com/sparanoid/almace-scaffolding/commit/347624c9))
  * new post “iTunes Artwork Grabber” ([6e562a32](https://github.com/sparanoid/almace-scaffolding/commit/6e562a32))
  * add new screenshots for “Delicious” ([791566c8](https://github.com/sparanoid/almace-scaffolding/commit/791566c8))
  * new post “Shutdown Like a Boss” ([df164f6c](https://github.com/sparanoid/almace-scaffolding/commit/df164f6c))
  * use markdown for pages ([59bfcb89](https://github.com/sparanoid/almace-scaffolding/commit/59bfcb89))
  * update post “Chinese Copywriting Guidelines” ([3b021f32](https://github.com/sparanoid/almace-scaffolding/commit/3b021f32))
  * update post heading ([9be83090](https://github.com/sparanoid/almace-scaffolding/commit/9be83090))
  * new post “Chinese Copywriting Guidelines” ([67e3ea35](https://github.com/sparanoid/almace-scaffolding/commit/67e3ea35))
  * update external link for “Free” Dribbble Invite ([f5763fe8](https://github.com/sparanoid/almace-scaffolding/commit/f5763fe8))
  * update post excerpts ([f57c1f46](https://github.com/sparanoid/almace-scaffolding/commit/f57c1f46))
  * add new post “Space Lover” and “Disable WYSIWYG” ([f9b5f4ad](https://github.com/sparanoid/almace-scaffolding/commit/f9b5f4ad))
  * update posts for discontinued external links ([744f32f4](https://github.com/sparanoid/almace-scaffolding/commit/744f32f4))
  * new post “AVOS Cloud” ([f6ed5f63](https://github.com/sparanoid/almace-scaffolding/commit/f6ed5f63))
  * update “Kai Series” color scheme ([3457b2a8](https://github.com/sparanoid/almace-scaffolding/commit/3457b2a8))
  * update post “ReadWise” ([5195c1e1](https://github.com/sparanoid/almace-scaffolding/commit/5195c1e1))
* **print:** introduce print styles ([39fbb109](https://github.com/sparanoid/almace-scaffolding/commit/39fbb109))
* **script:** add `intense.js` exclude rule ([73a8e250](https://github.com/sparanoid/almace-scaffolding/commit/73a8e250))
* **style:**
  * monospace fonts look bigger than normal fonts, so make it smaller ([5ef4fb87](https://github.com/sparanoid/almace-scaffolding/commit/5ef4fb87))
  * disable WebKit hyphens, it sucks ([f119ccc1](https://github.com/sparanoid/almace-scaffolding/commit/f119ccc1))
  * refine font size ([7b345668](https://github.com/sparanoid/almace-scaffolding/commit/7b345668))
  * custom inlined-style list ([aae14607](https://github.com/sparanoid/almace-scaffolding/commit/aae14607))
  * update media queries position ([826c4966](https://github.com/sparanoid/almace-scaffolding/commit/826c4966))
  * placeholder text color ([3f6fbf63](https://github.com/sparanoid/almace-scaffolding/commit/3f6fbf63))
  * update `text-align` method ([2665a791](https://github.com/sparanoid/almace-scaffolding/commit/2665a791))
  * simplified align center method ([aa0a5fbf](https://github.com/sparanoid/almace-scaffolding/commit/aa0a5fbf))
  * split style fixes for plug-ins into a isolated stylesheet ([8e587481](https://github.com/sparanoid/almace-scaffolding/commit/8e587481))
  * tweak font size for small devices ([66394316](https://github.com/sparanoid/almace-scaffolding/commit/66394316))
  * update header font size for small devices ([52e3ebd7](https://github.com/sparanoid/almace-scaffolding/commit/52e3ebd7))
  * add a fun transition ([6692e032](https://github.com/sparanoid/almace-scaffolding/commit/6692e032))
  * remove custom CSS background check ([fbfff18c](https://github.com/sparanoid/almace-scaffolding/commit/fbfff18c))
  * move `syntax.less` to `custom.less` ([b6fdb462](https://github.com/sparanoid/almace-scaffolding/commit/b6fdb462))
  * add some space for tables ([35cd7830](https://github.com/sparanoid/almace-scaffolding/commit/35cd7830))
  * dynamic text color for `code` and `pre` ([e153b87a](https://github.com/sparanoid/almace-scaffolding/commit/e153b87a))
  * update alternative title font size ([416c4161](https://github.com/sparanoid/almace-scaffolding/commit/416c4161))
  * add alternative title font size. ([277ead44](https://github.com/sparanoid/almace-scaffolding/commit/277ead44))
  * fix GitHub Gist default style, more layout padding and list nesting fixes ([32bb4053](https://github.com/sparanoid/almace-scaffolding/commit/32bb4053))
  * better custom color scheme support, syntax highlighting also support different c ([e17eb740](https://github.com/sparanoid/almace-scaffolding/commit/e17eb740))
  * update `.browser` style ([127c5b6d](https://github.com/sparanoid/almace-scaffolding/commit/127c5b6d))
  * make highlighter theme works for all color scheme (hint: LESS color functions) ([5556eef4](https://github.com/sparanoid/almace-scaffolding/commit/5556eef4))
  * remove obsoleted FlesSlider styles ([fd75b04c](https://github.com/sparanoid/almace-scaffolding/commit/fd75b04c))
  * update status text color ([5a388e1b](https://github.com/sparanoid/almace-scaffolding/commit/5a388e1b))
  * more viewport unit ([364c5ad1](https://github.com/sparanoid/almace-scaffolding/commit/364c5ad1))
  * SVG headlines got viewport units support ([f818a7b1](https://github.com/sparanoid/almace-scaffolding/commit/f818a7b1))
  * remove unused `.btn` class ([600121ff](https://github.com/sparanoid/almace-scaffolding/commit/600121ff))
  * simplified transition ([3e8baa82](https://github.com/sparanoid/almace-scaffolding/commit/3e8baa82))
  * add a simple table style ([7b01cf56](https://github.com/sparanoid/almace-scaffolding/commit/7b01cf56))
  * add syntax highlight support ([006e14f1](https://github.com/sparanoid/almace-scaffolding/commit/006e14f1))
  * smaller margin space for image post title ([4eac0fda](https://github.com/sparanoid/almace-scaffolding/commit/4eac0fda))
* **template:**
  * add main content class support ([05335815](https://github.com/sparanoid/almace-scaffolding/commit/05335815))
  * use custom `grunt-html-smoosher` ([94a87c95](https://github.com/sparanoid/almace-scaffolding/commit/94a87c95))
  * strip unwanted whitespaces ([0ce08c0a](https://github.com/sparanoid/almace-scaffolding/commit/0ce08c0a))
  * update remote server deployment ([6b31c70b](https://github.com/sparanoid/almace-scaffolding/commit/6b31c70b))
  * add canonical link support ([84ab1e8d](https://github.com/sparanoid/almace-scaffolding/commit/84ab1e8d))
  * better template structures ([c3191b36](https://github.com/sparanoid/almace-scaffolding/commit/c3191b36))
  * `twitter-cards` is now `open-graph` ([e3edcff5](https://github.com/sparanoid/almace-scaffolding/commit/e3edcff5))
  * add custom head and foot hooks ([1ee7d566](https://github.com/sparanoid/almace-scaffolding/commit/1ee7d566))
  * update post date format ([46cf345f](https://github.com/sparanoid/almace-scaffolding/commit/46cf345f))
  * modern page titles ([a1dedc01](https://github.com/sparanoid/almace-scaffolding/commit/a1dedc01))
  * update email subscription template ([af2795d7](https://github.com/sparanoid/almace-scaffolding/commit/af2795d7))
  * move pages into `_pages` ([6d705c27](https://github.com/sparanoid/almace-scaffolding/commit/6d705c27))
  * add feed excerpt output ([8fd053c5](https://github.com/sparanoid/almace-scaffolding/commit/8fd053c5))
  * remove Google+ authority support, I don't like it. ([0dd4efae](https://github.com/sparanoid/almace-scaffolding/commit/0dd4efae))
  * add multiple authors support ([57337fa1](https://github.com/sparanoid/almace-scaffolding/commit/57337fa1))
  * new email newsletter signup page ([a0652321](https://github.com/sparanoid/almace-scaffolding/commit/a0652321))
  * more centered text for pages ([2e476d91](https://github.com/sparanoid/almace-scaffolding/commit/2e476d91))
  * use `<h1>` for post list ([530f63c2](https://github.com/sparanoid/almace-scaffolding/commit/530f63c2))
  * reuse `h1` to post heading ([a85184a9](https://github.com/sparanoid/almace-scaffolding/commit/a85184a9))
  * add alternative text align mode ([008215fc](https://github.com/sparanoid/almace-scaffolding/commit/008215fc))
  * add `post-content` and `page-content` for convenient ([38be1975](https://github.com/sparanoid/almace-scaffolding/commit/38be1975))
  * update list template ([800c5ee3](https://github.com/sparanoid/almace-scaffolding/commit/800c5ee3))
  * add custom CSS support for pages ([742cbfcd](https://github.com/sparanoid/almace-scaffolding/commit/742cbfcd))
  * add `lang` YAML front-matter data ([a3d25f97](https://github.com/sparanoid/almace-scaffolding/commit/a3d25f97))
  * add `lang` YAML front-matter data ([911353f1](https://github.com/sparanoid/almace-scaffolding/commit/911353f1))
  * hide post from Atom feed ([32f36de7](https://github.com/sparanoid/almace-scaffolding/commit/32f36de7))
  * remove `amsf` option, add `clean_homepage` and `credits` options ([89016b8d](https://github.com/sparanoid/almace-scaffolding/commit/89016b8d))
  * better HTML structure ([fea47fdf](https://github.com/sparanoid/almace-scaffolding/commit/fea47fdf))
  * simplified script structure ([05de9818](https://github.com/sparanoid/almace-scaffolding/commit/05de9818))
  * move all custom variables to default `_config.yml` ([92a69fb0](https://github.com/sparanoid/almace-scaffolding/commit/92a69fb0))
  * use assign statement for post link ([2b79f39b](https://github.com/sparanoid/almace-scaffolding/commit/2b79f39b))
  * update Atom template ([73c236bf](https://github.com/sparanoid/almace-scaffolding/commit/73c236bf))
  * make normal image headers responsive ([c5d3a185](https://github.com/sparanoid/almace-scaffolding/commit/c5d3a185))
  * update template variables ([874ccb06](https://github.com/sparanoid/almace-scaffolding/commit/874ccb06))
  * remove Alipay donate link ([f42ed071](https://github.com/sparanoid/almace-scaffolding/commit/f42ed071))
  * better variables structure ([af58b736](https://github.com/sparanoid/almace-scaffolding/commit/af58b736))
  * remove all FlexSlider instances ([4124d6ad](https://github.com/sparanoid/almace-scaffolding/commit/4124d6ad))
  * better inline SVG post title support ([6c33d1d6](https://github.com/sparanoid/almace-scaffolding/commit/6c33d1d6))
  * inline SVG headline support ([89d3dac3](https://github.com/sparanoid/almace-scaffolding/commit/89d3dac3))
  * better Twitter Cards support ([39d5c5e9](https://github.com/sparanoid/almace-scaffolding/commit/39d5c5e9))
  * add Redcarpet footnote support ([2c9d67f4](https://github.com/sparanoid/almace-scaffolding/commit/2c9d67f4))
  * remove `.txt` wrapper ([1f400475](https://github.com/sparanoid/almace-scaffolding/commit/1f400475))
  * update footer and read me for new jksf (a.k.a. Jekyll Scaffolding) branding ([13de5820](https://github.com/sparanoid/almace-scaffolding/commit/13de5820))
  * remove SVG icons ([860f6b4b](https://github.com/sparanoid/almace-scaffolding/commit/860f6b4b))
  * try `minimal-ui` for iOS 7.1+ ([0215e148](https://github.com/sparanoid/almace-scaffolding/commit/0215e148))
* **work:** update categories ([445de41c](https://github.com/sparanoid/almace-scaffolding/commit/445de41c))
...
* Jekyll removes this support by default, you need install `jekyll-gist` plugin to support Gists
 ...
 ([f88b0137](https://github.com/sparanoid/almace-scaffolding/commit/f88b0137))
* Now that Kramdown and Rouge are used as markdown parser and syntax highlighter, please check if everything work as expected.
 ...
 ([43209734](https://github.com/sparanoid/almace-scaffolding/commit/43209734))
* Now `grunt-html-smoosher` only inline files with specific data attribute.

 ([94a87c95](https://github.com/sparanoid/almace-scaffolding/commit/94a87c95))
* this commit changes the way you push compiled files to remote servers. Now I changed my server from Linode VPS to Amazon S3 and CloudFront, I also changed my feed URL from /feed/ to /feed.xml since Amazon S3 doesn't support multiple Document Index.

 ([6b31c70b](https://github.com/sparanoid/almace-scaffolding/commit/6b31c70b))
* major template update, you should update all your template files if you need further updates.

 ([c3191b36](https://github.com/sparanoid/almace-scaffolding/commit/c3191b36))
...
```
 ...
 ([1ee7d566](https://github.com/sparanoid/almace-scaffolding/commit/1ee7d566))
* All pages are moved into `_pages` for better file structure management

 ([6d705c27](https://github.com/sparanoid/almace-scaffolding/commit/6d705c27))
...
* Force UTF-8 encoding, enable this will simply add <meta charset=utf-8> to the head of your pages, it's useful for local development since local server doesn't send charset in their respond header.
 ...
 ([0fb4c702](https://github.com/sparanoid/almace-scaffolding/commit/0fb4c702))
...
```
 ...
 ([a3d25f97](https://github.com/sparanoid/almace-scaffolding/commit/a3d25f97))
* Now you can define `lang` tag for your post, simply add `lang` to your post front-matter data, for example:
...
```
 ...
 ([911353f1](https://github.com/sparanoid/almace-scaffolding/commit/911353f1))
* Add `hidden: true` as YAML front-matter data to the post you want to hide from your feed output.

 ([32f36de7](https://github.com/sparanoid/almace-scaffolding/commit/32f36de7))
* Please note that templates should be updated for new options

 ([89016b8d](https://github.com/sparanoid/almace-scaffolding/commit/89016b8d))
* Now I can generate production site in a sub-directory in an easier way, just define `base` in `_config.yml` and run `grunt` everything should work
 ...
 ([bb62c8eb](https://github.com/sparanoid/almace-scaffolding/commit/bb62c8eb))
* It's expected to use something like `escape_once` from Liquid, but it's buggy right now: https://github.com/Shopify/liquid/issues/283
 ...
 ([7be60fc2](https://github.com/sparanoid/almace-scaffolding/commit/7be60fc2))
* Now all custom variables go to `_config.yml`, original `var.yml` will no longer available. all related template tags have been update for new variable structure.

 ([92a69fb0](https://github.com/sparanoid/almace-scaffolding/commit/92a69fb0))
...
- `rss_excerpt`: Use post excerpt instead of full content for RSS feeds, just like WordPress RSS feed output option
 ...
 ([73c236bf](https://github.com/sparanoid/almace-scaffolding/commit/73c236bf))
...
```
 ...
 ([c5d3a185](https://github.com/sparanoid/almace-scaffolding/commit/c5d3a185))
...
- In most cases, you have to define `svg-headline-width` and `svg-headline-height` in order to make your SVG title responsive to your viewport.
 ...
 ([6c33d1d6](https://github.com/sparanoid/almace-scaffolding/commit/6c33d1d6))
* Now this framework got even faster, SVG post titles can be inlined in HTML when use `svg-headline`in post front-matter:

```
---
title: Hello World!
category: work
svg-headline: insert_your_SVG_raw_here
svg-headline-width: 400
svg-headline-height: 145
---
```

Note: In most cases, you have to define `svg-headline-width` and `svg-headline-height` in order to make your SVG title responsive to your viewport.

 ([89d3dac3](https://github.com/sparanoid/almace-scaffolding/commit/89d3dac3))
...
You can read more about the footnote syntax at https://github.com/vmg/redcarpet
 ...
 ([2c9d67f4](https://github.com/sparanoid/almace-scaffolding/commit/2c9d67f4))
* Removal of `.txt` CSS class may break your existing post layout. Now `.txt` is replaced with `main.content`, a global content wrapper. To fix layout breaks for your existing site: simply remove all `<div class=txt>` containers from your posts
 ...
 ([1f400475](https://github.com/sparanoid/almace-scaffolding/commit/1f400475))
* This will remove a SVG icon decorations for `.note`, `.store`, and `.download`

 ([860f6b4b](https://github.com/sparanoid/almace-scaffolding/commit/860f6b4b))
* `smoosher` task will inline all `.css` and .js` files to reduce HTTP requests and increase load performance. It's ideal for small website with some basic styles just like this project.
 ...
 ([9d4dcb25](https://github.com/sparanoid/almace-scaffolding/commit/9d4dcb25))
